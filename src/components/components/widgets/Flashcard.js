...
const Flashcard=({internals,widgetClicked})=>
{
    ...
    return (
        <div className="flashcard">
            <div style={{justifyContent:'space-between',display:'flex'}}>
                <button className='leftButton' onClick={()=>{onChangeIndex(-1);widgetClicked();}}>
                ...
                <button className='rightButton' onClick={()=>{onChangeIndex(1);widgetClicked();}}>
                    <img src={rightIcon} height='30px' width='30px' alt="right"/>
                </button>
                
            </div>
            <div style={{marginTop: '1%'}} className='clearfix'>
                <button style={{paddingBottom:'10%'}} className='bottomButton' onClick={()=>{setFront(r=>!r);widgetClicked();}}>
